...
[Icons]
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon;IconFilename: "C:\Users\ààààðìíðâ\Source\Repos\VladimirBelchikov\ContactsApp\Setup\Release\Icon.ico"
